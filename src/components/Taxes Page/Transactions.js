...
import { txns } from '../../redux/incomeTax/selectors';
...
function Transactions() {
    ...
    function deleteTxn(id) {
        ...
        axios
            .delete('/incometax/deltxn/', { data: data })
            .then((res) => {
        ...
        <div>
            <div className="jumbotron jumbotron-fluid text-center">
                <div className="container">
                    <h1 className="display-4 font-weight-bold">Taxes Paid</h1>
                    <hr className="my-4" />
                </div>
