...
import { loanTxns } from '../../redux/loans/selectors';

function Transactions() {
    const isLoading = useSelector(loading);
    const data = useSelector(loanTxns);
        ...
        <div>
            <div className="jumbotron jumbotron-fluid text-center">
                <div className="container">
                    <h1 className="display-4 font-weight-bold">EMIs Paid</h1>
                    <hr className="my-4" />
                </div>
